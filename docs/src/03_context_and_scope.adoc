...
|**HTTPS (Browser → WebApp)** |User moves, strategy, login info. |Board updates, results, statistics.
...
image::Technical_Sequence_Component_diagram.png[Diagrama de Secuencia, width=600, align="center"]
