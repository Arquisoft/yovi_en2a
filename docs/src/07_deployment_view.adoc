...
node "Azure VM\n(Docker Compose)" as Azure #F0F0F0 {
    ...
    rectangle "Prometheus\n(:9090)" as Prometheus #FFFFFF
    rectangle "Grafana\n(:9091)" as Grafana #FFFFFF
}
...
Prometheus --> UsersAPI : scrape metrics
...
| **Prometheus** | Docker container scraping metrics from the Users API for operational monitoring.
| **Grafana** | Docker container providing dashboards fed by Prometheus for visualizing system health.
|===
